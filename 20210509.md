...
## 参考资料
[毕设分享：用Unity探究2D游戏的打击感](https://indienova.com/u/ahoy/blogread/17700)
[【unity2D】cinemachine-学习记录1-代码控制屏幕震动](https://www.cnblogs.com/OtusScops/p/14618538.html)
...
![image](https://img2020.cnblogs.com/blog/2346211/202104/2346211-20210429110842706-1851860842.png)
...
## 前言
[Light2D-学习记录2](https://www.cnblogs.com/OtusScops/p/14715438.html)中的颜色变化是一段式的，如下图箭头所示
![image](https://img2020.cnblogs.com/blog/2346211/202104/2346211-20210429173055751-457658937.png)

而当我们需要**颜色分2段连续变化时**，它应当这样变化
...
1. delegate变量作为函数容器，可以**同时被委任多个函数**。这种delegate一般被称为multicast delegate。

2. 函数原型相同时，把这类函数传递到delegate上，delegate就能**按照“装载”顺序，执行它“装载”的所有函数**。
...
2. UnityEvent和C#Event在语法上有较大区别。

3. UnityEvent在语法上再也见不到Delegate了，所以，即使不学Delegate，也能学UnityEvent。不过，要是学了Delegate和C#Event的话，理解UnityEvent会比较容易，建议都学。
...
## 参考资料
[【Unity3D API的学习与使用】Unity中的事件响应——UnityEvent](https://blog.csdn.net/zgljl2012/article/details/44610353)
[做游戏 - Unity技术与技巧 - 事件（Event）](https://www.bilibili.com/read/cv6429868)
[C# Event/UnityEvent辨析](https://blog.csdn.net/qq_28849871/article/details/78366236)
...
## 前言
在[委托Delegate](https://www.cnblogs.com/OtusScops/p/14722349.html)里我们学习了多播委托（multicast delegate）。在C#Event中，用一个委托执行多个方法，就是多播委托。而在UnityEvent中，要实现多播委托，可以直接写，也可以使用UnityAction。
...
运行结果如图：
![image](https://img2020.cnblogs.com/blog/2346211/202105/2346211-20210502171048803-1220447253.png)
## 注意事项
根据上面的代码，我们可以看出一些端倪：
...
2. 模拟出了时间的推移，接下来，只需在特定时间段内，平滑地调整场景灯光的色彩、明暗即可。
...
2D全局光照：
	...
	public class GlobalLightTest : MonoBehaviour
	{
		...
		public List<Color> colors = new List<Color>();//在方法里对这个集合进行操作，以减少代码对colors的耦合度
...
### 不足
这段代码是为了快速实现2D光照变化，如果有更复杂的需求，则需要改动。
...
![image](https://img2020.cnblogs.com/blog/2346211/202105/2346211-20210504105244122-1513649570.gif)
